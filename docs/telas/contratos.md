...
**Rota:** `/contratos`
**Arquivo:** `src/pages/Contratos.js`

---

## O que é

Gestão dos contratos firmados com os parceiros. Vinculado ao Pipeline — um contrato pode ser gerado a partir de uma oportunidade ganha.
...
3. Preencha: número, empresa, produtos, valores, vigência e condições
4. Salva
...
Contratos com pagamentos em atraso são destacados visualmente na lista.
