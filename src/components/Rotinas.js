...
const s = {
  ...
  drawer:  { width:'100%', maxWidth:400, height:'100vh', background:C.bg, borderLeft:`1px solid ${C.border}`, display:'flex', flexDirection:'column', boxSizing:'border-box' },
  ...
  wizard:  { width:'100%', maxWidth:580, maxHeight:'90vh', background:C.bg, borderRadius:12, border:`1px solid ${C.border}`, display:'flex', flexDirection:'column', overflow:'hidden', boxSizing:'border-box' },
}
