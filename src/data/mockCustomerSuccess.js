...
// Em produção: tabela `customer_health` no Supabase com RLS por tenant_id
...
export const STORAGE_KEY = 'cs:customer_health_v1'

export const MOCK_CUSTOMER_HEALTH = [
  {
    id: 'ch1', tenant_id: 't1', company_id: 1,
    company_name: 'Nexus Tech', company_city: 'São Paulo', company_uf: 'SP',
    csm: 'Carla Menezes',
    laer_stage: 'Expand', touch_model: 'High-Touch',
    health_score: 87,
    renewal_date: '2026-12-31',
    notes: 'Cliente estratégico com alto engajamento. Concluiu onboarding em tempo recorde e já expandiu para 3 filiais.',
    action_plans: [
      { id: 'ap1', text: 'QBR agendado para 2026-07-15', done: false },
      { id: 'ap2', text: 'Apresentar módulo de Analytics Pro', done: false },
      { id: 'ap3', text: 'Indicar ao programa de clientes Gold', done: true },
    ],
    checkins: [
  ...
  {
    id: 'ch2', tenant_id: 't1', company_id: 2,
  ...
  {
    id: 'ch3', tenant_id: 't1', company_id: 6,
    company_name: 'FinCorp Soluções', company_city: 'Porto Alegre', company_uf: 'RS',
    csm: 'Lucas Ferreira',
    laer_stage: 'Land', touch_model: 'High-Touch',
    health_score: 41,
    renewal_date: '2027-03-31',
    notes: 'Novo cliente. Onboarding em andamento. Equipe pequena, requer acompanhamento intensivo.',
    action_plans: [
  ...
  {
    id: 'ch5', tenant_id: 't1', company_id: 5,
    ...
    notes: 'Cliente digital-first. Usa bastante o portal self-service. Engajamento via email automático.',
    action_plans: [
  ...
  {
    id: 'ch6', tenant_id: 't1', company_id: 7,
