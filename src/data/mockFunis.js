...
export const MOCK_FUNIS = [
  {
    ...
    etapas: [
      ...
      { id: 13, nome: 'Proposta',        ordem: 3, cor: '#8B5CF6', probabilidade: 50 },
  ...
  },
  {
    ...
    etapas: [
      ...
      { id: 23, nome: 'Proposta Enviada',  ordem: 3, cor: '#8B5CF6', probabilidade: 55 },
  ...
  },
  {
    ...
    etapas: [
      ...
      { id: 34, nome: 'Proposta Técnica',  ordem: 4, cor: '#8B5CF6', probabilidade: 50 },
