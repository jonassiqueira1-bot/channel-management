...
function rowToOpp(row) {
  ...
  return {
    ...
    campanha_id:           cf.campanha_id || null,
    playbook_ids:          row.playbook_ids || [],
    playbook_ids_excluidos: cf.playbook_ids_excluidos || [],
    playbook_ids_manual:   cf.playbook_ids_manual || [],
...
function oppToRow(opp, tenantId, branchId) {
  return {
    ...
    custom_fields: {
      ...
      playbook_ids_excluidos: opp.playbook_ids_excluidos || [],
      playbook_ids_manual:   opp.playbook_ids_manual || [],
      campanha_id:           opp.campanha_id || null,
