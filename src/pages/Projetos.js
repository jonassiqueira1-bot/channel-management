...
const pg = {
  ...
  toolbar:    { background: 'var(--surface)', borderRadius: 10, padding: '8px 12px', border: '1px solid var(--border2)', boxShadow: 'var(--shadow)', display: 'flex', alignItems: 'center', justifyContent: 'space-between', gap: 8, flexWrap: 'nowrap', overflow: 'hidden' },
  tbLeft:     { display: 'flex', alignItems: 'center', gap: 6, flexShrink: 1, minWidth: 0, flexWrap: 'nowrap', overflow: 'hidden' },
  tbRight:    { display: 'flex', alignItems: 'center', gap: 6, flexShrink: 0, flexWrap: 'nowrap' },
