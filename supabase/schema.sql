...
-- Versão: 1.1 | Ordem correta: tabelas → funções → RLS
-- ============================================================
...
-- Provisiona roles base ao criar tenant
...
-- (definidas após as tabelas que referenciam)
-- ============================================================
...
RETURNS boolean LANGUAGE sql STABLE SECURITY DEFINER AS $$
  SELECT EXISTS (
    ...
    WHERE brs.record_id          = has_branch_access.record_id
      ...
      AND (brs.shared_to_branch_id = public.my_branch_id() OR brs.shared_to_branch_id IS NULL)
      AND (brs.shared_to_role IS NULL OR brs.shared_to_role = public.my_role())
...
RETURNS boolean LANGUAGE sql STABLE SECURITY DEFINER AS $$
  SELECT
    ...
    OR (rec_branch_id IS NULL OR rec_branch_id = public.my_branch_id())
    OR EXISTS (
...
-- tenant_roles
CREATE POLICY "roles: view"   ON public.tenant_roles FOR SELECT USING (tenant_id = public.my_tenant_id());
CREATE POLICY "roles: manage" ON public.tenant_roles FOR ALL    USING (tenant_id = public.my_tenant_id() AND public.my_role() = 'admin_isv');
...
CREATE POLICY "profiles: same branch" ON public.profiles FOR SELECT USING (tenant_id = public.my_tenant_id() AND branch_id = public.my_branch_id());
...
-- companies
CREATE POLICY "companies: select" ON public.companies FOR SELECT USING (tenant_id = public.my_tenant_id() AND public.can_see_branch_record(branch_id, id, 'companies'));
CREATE POLICY "companies: insert" ON public.companies FOR INSERT WITH CHECK (tenant_id = public.my_tenant_id());
CREATE POLICY "companies: update" ON public.companies FOR UPDATE USING (tenant_id = public.my_tenant_id() AND (public.my_role() = 'admin_isv' OR branch_id = public.my_branch_id()));
...
-- contacts
CREATE POLICY "contacts: select" ON public.contacts FOR SELECT USING (tenant_id = public.my_tenant_id() AND public.can_see_branch_record(branch_id, id, 'contacts'));
CREATE POLICY "contacts: insert" ON public.contacts FOR INSERT WITH CHECK (tenant_id = public.my_tenant_id());
CREATE POLICY "contacts: update" ON public.contacts FOR UPDATE USING (tenant_id = public.my_tenant_id() AND (public.my_role() = 'admin_isv' OR branch_id = public.my_branch_id()));
...
-- opportunities
CREATE POLICY "opps: select" ON public.opportunities FOR SELECT USING (tenant_id = public.my_tenant_id() AND public.can_see_branch_record(branch_id, id, 'opportunities'));
CREATE POLICY "opps: insert" ON public.opportunities FOR INSERT WITH CHECK (tenant_id = public.my_tenant_id());
CREATE POLICY "opps: update" ON public.opportunities FOR UPDATE USING (tenant_id = public.my_tenant_id() AND (public.my_role() = 'admin_isv' OR branch_id = public.my_branch_id()));
CREATE POLICY "opps: delete" ON public.opportunities FOR DELETE USING (tenant_id = public.my_tenant_id() AND public.my_role() = 'admin_isv');
...
-- projects
CREATE POLICY "projects: select" ON public.projects FOR SELECT USING (tenant_id = public.my_tenant_id() AND public.can_see_branch_record(branch_id, id, 'projects'));
CREATE POLICY "projects: insert" ON public.projects FOR INSERT WITH CHECK (tenant_id = public.my_tenant_id());
CREATE POLICY "projects: update" ON public.projects FOR UPDATE USING (tenant_id = public.my_tenant_id() AND (public.my_role() = 'admin_isv' OR branch_id = public.my_branch_id()));
CREATE POLICY "projects: delete" ON public.projects FOR DELETE USING (tenant_id = public.my_tenant_id() AND public.my_role() = 'admin_isv');

-- contracts
CREATE POLICY "contracts: select" ON public.contracts FOR SELECT USING (tenant_id = public.my_tenant_id() AND public.can_see_branch_record(branch_id, id, 'contracts'));
CREATE POLICY "contracts: insert" ON public.contracts FOR INSERT WITH CHECK (tenant_id = public.my_tenant_id());
CREATE POLICY "contracts: update" ON public.contracts FOR UPDATE USING (tenant_id = public.my_tenant_id() AND (public.my_role() = 'admin_isv' OR branch_id = public.my_branch_id()));
CREATE POLICY "contracts: delete" ON public.contracts FOR DELETE USING (tenant_id = public.my_tenant_id() AND public.my_role() = 'admin_isv');

-- payments
CREATE POLICY "payments: select" ON public.payments FOR SELECT USING (tenant_id = public.my_tenant_id() AND public.can_see_branch_record(branch_id, id, 'payments'));
CREATE POLICY "payments: insert" ON public.payments FOR INSERT WITH CHECK (tenant_id = public.my_tenant_id());
CREATE POLICY "payments: update" ON public.payments FOR UPDATE USING (tenant_id = public.my_tenant_id() AND (public.my_role() = 'admin_isv' OR branch_id = public.my_branch_id()));
CREATE POLICY "payments: delete" ON public.payments FOR DELETE USING (tenant_id = public.my_tenant_id() AND public.my_role() = 'admin_isv');

-- actions
CREATE POLICY "actions: select" ON public.actions FOR SELECT USING (tenant_id = public.my_tenant_id() AND public.can_see_branch_record(branch_id, id, 'actions'));
CREATE POLICY "actions: insert" ON public.actions FOR INSERT WITH CHECK (tenant_id = public.my_tenant_id());
CREATE POLICY "actions: update" ON public.actions FOR UPDATE USING (tenant_id = public.my_tenant_id() AND (public.my_role() = 'admin_isv' OR branch_id = public.my_branch_id() OR owner_id = auth.uid()));
CREATE POLICY "actions: delete" ON public.actions FOR DELETE USING (tenant_id = public.my_tenant_id() AND public.my_role() = 'admin_isv');

-- sellers
CREATE POLICY "sellers: select" ON public.sellers FOR SELECT USING (tenant_id = public.my_tenant_id() AND public.can_see_branch_record(branch_id, id, 'sellers'));
CREATE POLICY "sellers: manage" ON public.sellers FOR ALL    USING (tenant_id = public.my_tenant_id() AND public.my_role() = 'admin_isv');

-- branch_record_shares
CREATE POLICY "shares: view"   ON public.branch_record_shares FOR SELECT USING (tenant_id = public.my_tenant_id());
CREATE POLICY "shares: manage" ON public.branch_record_shares FOR ALL    USING (tenant_id = public.my_tenant_id() AND public.my_role() = 'admin_isv');
...
-- form_layouts
CREATE POLICY "form_layouts: view"   ON public.form_layouts FOR SELECT USING (tenant_id = public.my_tenant_id());
CREATE POLICY "form_layouts: manage" ON public.form_layouts FOR ALL    USING (tenant_id = public.my_tenant_id() AND public.my_role() = 'admin_isv');

-- sidebar_config
CREATE POLICY "sidebar: view"   ON public.sidebar_config FOR SELECT USING (tenant_id = public.my_tenant_id() AND (profile_id IS NULL OR profile_id = auth.uid()));
CREATE POLICY "sidebar: upsert" ON public.sidebar_config FOR ALL    USING (tenant_id = public.my_tenant_id() AND (profile_id = auth.uid() OR (profile_id IS NULL AND public.my_role() = 'admin_isv')));
